...
const Banner = () => {
	...
	<div className="container flex flex-col justify-center p-6 mx-auto sm:py-12 lg:py-24 lg:flex-row lg:justify-between">
		<div className="flex flex-col justify-center p-6 text-center rounded-sm lg:max-w-lg xl:max-w-lg lg:text-left" data-aos="fade-down-right"
     ...
     data-aos-duration="1500">
		...
		<div className="flex items-center justify-center rainbow p-6 mt-8 lg:mt-0 h-72 sm:h-80 lg:h-96 xl:h-112 2xl:h-128" data-aos="zoom-in"
     data-aos-easing="linear"
     data-aos-duration="1500">
